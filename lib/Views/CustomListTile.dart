...
class _CustomListTileElement extends RenderObjectElement {
  ...
  final Map<Element, _CustomListTileSlot> childToSlot =
      <Element, _CustomListTileSlot>{};

  @override
  _CustomListTile get widget => super.widget;

  @override
  _RenderCustomListTile get renderObject => super.renderObject;
  ...
  void forgetChild(Element child) {
    ...
    final _CustomListTileSlot slot = childToSlot[child];
  ...
  void _updateRenderObject(RenderObject child, _CustomListTileSlot slot) {
    switch (slot) {
  ...
  void insertChildRenderObject(RenderObject child, dynamic slotValue) {
    ...
    assert(slotValue is _CustomListTileSlot);
    final _CustomListTileSlot slot = slotValue;
...
class _RenderCustomListTile extends RenderBox {
  ...
  static const double _minLeadingWidth = 10.0;
  // The horizontal gap between the titles and the leading/trailing widgets
  static const double _horizontalTitleGap = 7.0;
  // The minimum padding on the top and bottom of the title and subtitle widgets.
  static const double _minVerticalPadding = 4.0;

  final Map<_CustomListTileSlot, RenderBox> slotToChild =
      <_CustomListTileSlot, RenderBox>{};
  final Map<RenderBox, _CustomListTileSlot> childToSlot =
      <RenderBox, _CustomListTileSlot>{};
