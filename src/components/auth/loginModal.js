...
import {
    Logout, Google, Toast, Actions } from "grommet-icons";
                        ...
                        >
                            ...
                            >
                                ...
                                <DropButton
                                    ...
                                    dropContent={
                                        <Box direction='column'  align='start' justify='start' background={this.props.dark ? '#29324D' : "white"}>
                                            <Box
                                            ...
                                            <Button pad='small' fill='horizontal'  hoverIndicator onClick={() => {
                                            ...
                                            >
                                                ...
                                                >
                                                    <Actions />
                                                    <Text>{!this.props.dark ? ' enable darkmode' : ' disable darkmode'}</Text>
                                                    </Box>
                                            </Button>
                                            <Button fill='horizontal' pad='small' hoverIndicator onClick={this.logout}
                                            >
                                                <Box
                                                    pad={{ left: "10px", right: "10px" }}
                                                    gap='xsmall'
